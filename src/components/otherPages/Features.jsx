    ...
    <section className="flat-spacing-3">
      <div className="container">
        <div className="flat-title-2 text-center">
          <p className="display-md-2 fw-medium">Why Choose Zeyra</p>
          ...
          <div className="col-xl-7 col-md-6">
            <ul className="list-esd d-md-flex flex-md-column justify-content-md-center h-100">
              <li className="item">
                ...
                <p className="text-md">
                  At Zeyra, we are dedicated to upholding the highest ethical
              ...
              <li className="item">
                ...
                <p className="text-md">
                  From classic tailoring to casual staples, our Zeyra
