...
export default function ProductHeading({
  ...
  return (
    <div className={`tf-product-heading ${inStock ? "" : "pb-0 border-0"}`}>
      <span className="brand-product">Zeyra Enterprise</span>
      <h5 className="product-name fw-medium">Wall Hooks for Hanging (10 pieces)</h5>
      <div className="product-rate">
        ...
        <span className="count-review">(5k+ reviews)</span>
      </div>
      <div className="product-price">
        <div className="display-sm price-new price-on-sale">₹249.00</div>
        <div className="display-sm price-old">₹399.00</div>
