...
export default function Footer1({
  ...
  return (
    <footer
      id="footer"
      className={` ${parentClass} ${paddingBottom ? "footer-pb-2" : "xl-pb-70"
        } ${cloud ? "footer-cloud" : ""}`}
    >
                ...
                <div className="footer-contact">
                  <ul className="footer-info">
                    <li className="item">
                      ...
                      Zeyra Enterprises, Malappuram, Kerala, India
                    ...
                    <li className="item">
                      ...
                      <a href="tel:7034327244">(+91) 7034327244</a>
                    </li>
                    <li className="item">
                      <span className="box-icon">
                        <svg
        ...
        <div className="container">
          <div className="footer-bottom-wrap">
            <p className="text-dark">
              Copyright © {year} by <span className="fw-medium">Zeyra Enterprise.</span> All
              Rights Reserved.
            </p>
          </div>
        </div>
