          ...
          <div className="tf-mini-cart-wrap">
            ...
            >
              ...
              <form id="shipping-form" className="tf-mini-cart-tool-content">
                ...
                <div className="field">
                  ...
                  <div className="tf-select">
                    ...
                    >
                      <option
                        value="Australia"
                        data-proZeyras='[["Australian Capital Territory","Australian Capital Territory"],["New South Wales","New South Wales"],["Northern Territory","Northern Territory"],["Queensland","Queensland"],["South Australia","South Australia"],["Tasmania","Tasmania"],["Victoria","Victoria"],["Western Australia","Western Australia"]]'
                      >
                        Australia
                      </option>
                      <option value="Austria" data-proZeyras="[]">
                        Austria
                      </option>
                      <option value="Belgium" data-proZeyras="[]">
                        Belgium
                      </option>
                      <option
                        value="Canada"
                        data-proZeyras='[["Ontario","Ontario"],["Quebec","Quebec"]]'
                      >
                        Canada
                      </option>
                      <option value="Czech Republic" data-proZeyras="[]">
                        Czechia
                      </option>
                      <option value="Denmark" data-proZeyras="[]">
                        Denmark
                      </option>
                      <option value="Finland" data-proZeyras="[]">
                        Finland
                      </option>
                      <option value="France" data-proZeyras="[]">
                        France
                      </option>
                      <option value="Germany" data-proZeyras="[]">
                        Germany
                      </option>
                      <option
                        value="United States"
                        data-proZeyras='[["Alabama","Alabama"],["California","California"],["Florida","Florida"]]'
                      >
                        United States
                      </option>
                      <option
                        value="United Kingdom"
                        data-proZeyras='[["England","England"],["Scotland","Scotland"],["Wales","Wales"],["Northern Ireland","Northern Ireland"]]'
                      >
                        United Kingdom
                      </option>
                      <option value="India" data-proZeyras="[]">
                        India
                      </option>
                      <option value="Japan" data-proZeyras="[]">
                        Japan
                      </option>
                      <option value="Mexico" data-proZeyras="[]">
                        Mexico
                      </option>
                      <option value="South Korea" data-proZeyras="[]">
                        South Korea
                      </option>
                      <option value="Spain" data-proZeyras="[]">
                        Spain
                      </option>
                      <option value="Italy" data-proZeyras="[]">
                        Italy
                      </option>
                      <option
                        value="Vietnam"
                        data-proZeyras='[["Ha Noi","Ha Noi"],["Da Nang","Da Nang"],["Ho Chi Minh","Ho Chi Minh"]]'
                      >
                        Vietnam
                      </option>
                    </select>
                ...
                <div className="field">
                  <p className="text-sm">State/ProZeyra</p>
                  <div className="tf-select">
                    <select
                      id="shipping-proZeyra-form"
                      name="address[proZeyra]"
                      data-default=""
                    />
                  </div>
                </div>
